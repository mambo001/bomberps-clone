function openSimplexNoise(clientSeed) {
    ...
    function createContributionArray(type) {
        ...
        while (i < type.pD.length) {
            ...
            if (d >= 3) {
                current.next.next = createContribution(
                    type,
                    type.pD,
                    i + d + 2
                );
            ...
            if (d === 4) {
                current.next.next.next = createContribution(
                    type,
                    type.pD,
                    i + 11
                );
        ...
        noise3D(x, y, z) {
            ...
            while (c !== undefined) {
                ...
                if (attn > 0) {
                    ...
                    attn *= attn;
                    value +=
                        attn * attn * (g[i++] * dx + g[i++] * dy + g[i] * dz);
                }
                c = c.next;
            }
